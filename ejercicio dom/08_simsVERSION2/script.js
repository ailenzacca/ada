...
const personajeDos = Object.assign({}, sim, {img: `character_2.png`, nombre: "Popi", edad: 23, profesion: "profesora de historia", ubicacion: "Quilmes", info: "Bailarina profesional"});

const personajeTres = Object.assign({}, sim, {img: `character_3.png`, nombre: "Laura", edad: 30, profesion: "animadora de dia y pirata de noche", ubicacion: "Islas Canarias", info: "Capa encontrando tesoros"});

const personajeCuatro = Object.assign({}, sim, {img: `character_4.png`, nombre: "Ema", edad: 26, profesion: "Guionista", ubicacion: "New York", info: "Mejor guionista de Hollywood"});

const personajes = [sim, personajeDos, personajeTres, personajeCuatro];

// if(anterior){
//     for(const personaje = 0; personaje < personajes.length; personaje--){
...
siguiente.onclick = function(){
    i === personajes.length - 1  ? 0 : i++;

    actualizarSim(personajes[i]);
